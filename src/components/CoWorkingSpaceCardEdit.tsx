...
const CoWorkingSpaceCardEdit = ({ data = null, variant, token }: CoWorkingSpaceCardEditProps) => {
  ...
  const handleDelete = async () => {
    try {
      if(data?.id){
        const response = await deleteCoWorkingSpace(
          data.id,
          token
        );
  ...
  return (
    <div className="space-y-4 items-center">
      <UploadImage setImageUrl={setImageUrl} initialImageUrl={formData.picture}/>
      ...
      <div className='flex items-center justify-start space-x-4'>
        ...
        <TimeSelector initOpenTime={openTime} initCloseTime={closeTime} setOpenTime={setOpenTime} setCloseTime={setCloseTime}/>
